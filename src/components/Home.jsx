...
const Home = () => {
  return (
    <div>
      ...
      <div id="main" className="w-90  flex flex-col place-content-center m-auto items-center    ">
        { articles.map((articles,index)=>(
          <div id="box" key={`${index}-${articles.url}`}  className=" h-[330px] w-[400px] md:h-[400px] rounded-md bg-white md:w-[600px] mt-5 p-3 flex flex-col   items-center text-black border-double  ">
          <div className="">
          ...
          <div className="text-center w-full pt-2 ">
            ...
            <div className=" text-center w-full ">
              ...
              <a href={articles.url} className="text-black text-sm md:text-sm  pt-2 underline flex flex-row-reverse" >Click here to Read More</a>
            </div>
